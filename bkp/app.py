...
def submit():
    ...
    query = 'INSERT INTO enquiries (first_name, last_name, email, mobile, city, message) VALUES (%s, %s, %s, %s, %s, %s)'
    cursor.execute(query, (first_name, last_name, email, mobile, city, message))
    connection.commit()
