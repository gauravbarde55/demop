...
def header():
    ...
    # try:
    #     return render_template('header.html')  # or appropriate content
    # except Exception as e:
    #     return str(e), 500
    app.logger.info("Header endpoint accessed.")
    # return "Header Content", 200
    return render_template('header.html')
...
@app.route('/leadership_team', methods=['GET'])
def leadership_team():
    return render_template('leadership-team.html')
...
@app.route('/social_impact', methods=['GET'])
def social_impact():
...
@app.route('/events_library', methods=['GET'])
def events_library():
    return render_template('events-library.html')
...
def footer():
    try:
        # return render_template('footertest.html')  # or appropriate content
        return render_template('footer.html')  # or appropriate content
    except Exception as e:
        return str(e), 500
    # app.logger.info("Footer endpoint accessed.")
    # return "Footer Content", 200
...
@app.route('/microx_mastering_fundamental_analysis', methods=['GET'])
def microx_mastering_fundamental_analysis():
    # connection = mysql.connector.connect(**db_config)
    connection = get_db_connection()
    ...
    qualifications = cursor1.fetchall()
    # print(all_cities)
    return render_template('/microx/mastering-fundamental-analysis-online-course.html', all_cities=all_cities, qualifications=qualifications)
