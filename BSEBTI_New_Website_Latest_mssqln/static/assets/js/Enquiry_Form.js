...
async function updateCourseNames() {
    ...
    // function enableVerifyOTPButton() {
        ...
        // // Disable OTP Button If Number is Less than 10 Digit

        // let votp1 = document.getElementById('otp1');
        // let votp2 = document.getElementById('otp2');
        // let votp3 = document.getElementById('otp3');
        // let votp4 = document.getElementById('otp4');
        // // up.innerHTML = 
        // //       "Type in the input box to determine the pressed.";
        // votp1.addEventListener('keydown', function (event) {
        //     const key = event.key;
        ...
        // votp2.addEventListener('keydown', function (event) {
        //     const key = event.key;
        //     if (key === "Backspace" || key === "Delete") {
        //         disableVerifyOTPButton();
        //         // alert('B Pressed');
        ...
        //     }
        // }); 
        // votp3.addEventListener('keydown', function (event) {
        //     const key = event.key;
        //     if (key === "Backspace" || key === "Delete") {
        //         disableVerifyOTPButton();
        //         // alert('B Pressed');
        ...
        //     }
        // }); 
        // votp4.addEventListener('keydown', function (event) {
        //     const key = event.key;
        //     if (key === "Backspace" || key === "Delete") {
        //         disableVerifyOTPButton();
        //         // alert('B Pressed');
        ...
        // console.log('Enable Verify OTP Button Called');
        // otp1_val=document.getElementById('otp1').value;
        // otp2_val=document.getElementById('otp2').value;
        // otp3_val=document.getElementById('otp3').value;
        // otp4_val=document.getElementById('otp4').value;
        // console.log('otp1_val',typeof(otp1_val));
        // console.log('otp2_val',typeof(otp2_val));
        // console.log('otp3_val',otp3_val);
        // console.log('otp4_val',otp4_val);
        // if(string.IsNullOrEmpty(otp1_val)){
        ...
        // if((document.getElementById('otp1').value != '') && (document.getElementById('otp2').value != '') && (document.getElementById('otp3').value != '') && (document.getElementById('otp4').value != '')){
        //     console.log("Verify OTP Condition Satisfied");
        //     const verifyBtn = document.getElementById('verify_otp_btn');
        //     verifyBtn.classList.remove('disabled');
        //     verifyBtn.disabled = false; // Enable submit button

        //     // hideEnquiryFormPopup();
        //     // document.getElementById('otpPopup').style.display = 'none'; //// Close OTP Popup
        // }
        // else if((document.getElementById('otp1').value.trim != '') || (document.getElementById('otp2').value.trim != '') || (document.getElementById('otp3').value.trim != '') || (document.getElementById('otp4').value.trim != '')){
        //     console.log("Verify OTP Else Condition Satisfied");
        //     const verifyBtn = document.getElementById('verify_otp_btn');
        //     verifyBtn.classList.add('disabled');
        //     verifyBtn.disabled = true; // Enable submit button
        // }
    ...
    //     //Enable
    //     // Get a reference to the button element
    //     console.log('Disable Verify OTP Called');
    //     const button = document.getElementById("verify_otp_btn");
